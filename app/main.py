...
with engine.connect() as conn:
    try:
        ...
        conn.execute(text("ALTER TABLE tau_designations_v2 ADD COLUMN IF NOT EXISTS unit_confirmed VARCHAR"))
        conn.execute(text("ALTER TABLE tau_designations_v2 ADD COLUMN IF NOT EXISTS unit_confirmed_at TIMESTAMP"))
