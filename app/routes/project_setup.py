...
Commit message: Add POST handler for project creation + countries list



Edit 2: Update the template
Go to app/templates/project_setup.html → pencil icon.



Find this block (the Country field):
          ...
          <div>
            ...
            <input type="text" name="country" required
                   class="w-full px-3 py-2 bg-slate-900 border border-slate-600 rounded-lg text-white text-sm focus:border-emerald-500 focus:outline-none"
